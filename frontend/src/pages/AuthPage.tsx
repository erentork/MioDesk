  ...
  return (
    <div className="auth-page">
      ...
      <section className="auth-visual">
        ...
        <div className="auth-copy"><span className="eyebrow">Akademik hayatın, tek masada</span><h1>Derslerini ve hedeflerini tatlı bir düzenle yönet.</h1><p>Haftalık program, teslimler, post-it notlar, odak oturumları ve ilerleme istatistikleri bir arada.</p></div></section>
